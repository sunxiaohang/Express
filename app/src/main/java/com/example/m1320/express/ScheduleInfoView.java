...
//		editInfo = new BorderEditText(this, null);
//		editInfo.setTextColor(Color.GREEN);
//		editInfo.setBackgroundColor(Color.WHITE);
//		editInfo.setLayoutParams(params);
//		editInfo.setGravity(Gravity.CENTER_VERTICAL);
//		editInfo.setTextSize(100);
//		editInfo.setHeight(40);
//		editInfo.setPadding(10, 0, 10, 0);
